...
const Header = () => {
  function openNav() {
    ...
    document.body.classNameList.toggle("overflow_hidden");
    document.querySelector(".menu").classNameList.toggle("cross");
  }
  return (
    <div>
      <header className="bg-header-img">
        <nav className="pt20">
          <div className="container">
            <div className="d-flex align-items-center justify-content-between">
              <div className="d-flex align-items-center cusor-pointer">
                {" "}
                <svg
                  width="37"
                  height="39"
                ...
                >
                  <path
                    d="M28.6133 7.40008V4.93341H37V38.9734H0.493333L0 4.93341H8.38667V7.40008H4.44L18.7467 27.1334L33.0533 7.40008H28.6133Z"
                    fill="black"
                  />
                  <path
                    d="M25.1604 0L18.7471 5.92L25.1604 11.84V0Z"
                    fill="black"
                  />
                  <path
                    d="M11.8396 0L18.2529 5.92L11.8396 11.84V0Z"
                    fill="black"
                  />
                  <circle cx="18.2534" cy="12.8267" r="1.48" fill="black" />
                  <circle cx="18.2534" cy="18.7467" r="1.48" fill="black" />
                </svg>
                <p className="ff-work fw-4 fs-4sm color-black pt-3 mx-2">
                  maître d
                </p>
              </div>
              ...
              <ul className="d-flex align-items-center gap-48 mobile-view mt-16 list-unstyled">
                <li>
                  <a
                    href="#"
                    className="text-decoration-none ff-work fw-4 fs-2sm color-black nav-icon"
                  >
                    Home
                  </a>
                </li>
        ...
        <section>
          <div className="container">
            <h1 className="ff-work fw-8 fs-1lg color-black  text-center mx-auto header-top-padding head">
              Maitre D– Store <span className="position-relative">Management <svg className="manage-svg" xmlns="http://www.w3.org/2000/svg" width="96" height="95" viewBox="0 0 96 95" fill="none">
...
</svg></span> for Barbers
            </h1>
            <div className="d-flex justify-content-center pt-48">
              <a
                href="#"
                className="ff-work fw-7 fs-3sm color-white submit mx-auto text-decoration-none"
              >
                Submit
              </a>
            </div>
